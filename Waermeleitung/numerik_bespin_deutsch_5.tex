...
\subsubsection{Diskretisierung von $\Delta$}
Zur Bearbeitung der Aufgabe muss das betrachtete, zusammenhängende Gebiet in diskrete Teilstücke zerlegt werden, um das Problem numerisch zu lösen. Weiterhin müssen die Operatoren auf dem Gebiet auch entsprechend angepasst werden. Dieses Verfahren nennt sich Diskretisierung. 
Hierfür wird ein isotropes Gitter mit festem Gitterabstand $a$ in alle Richtungen gewählt. Mit Hilfe des Einheitsvektors in $\mu$-Richtung können von jedem Punkt $x$ ausgehend mit $x\pm a\vec{\mu}$ die Nachbarpunkte erreicht werden.
...
\centering
\vspace{-60pt}
\scalebox{0.9}{\input{./figures/heatmap_a_1}}
\vspace{-40pt}
\caption{Temperaturverteilung für $a=0,01$}
\label{fig:a_1}
\vspace{-20pt}
\scalebox{0.9}{\input{./figures/heatmap_a_10}}
\vspace{-40pt}
...
\centering
\vspace{-60pt}
\scalebox{0.9}{\input{./figures/heatmap_a_20}}
\vspace{-40pt}
\caption{Temperaturverteilung für $a=0,2$}
\label{fig:a_20}
\vspace{-20pt}
\scalebox{0.9}{\input{./figures/heatmap_a_25}}
\vspace{-40pt}
