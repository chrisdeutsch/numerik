...
Zur Berechnung des Gesamtwiderstands werden die Zusammenhänge zwischen den einzelnen, auf jeder Kante liegenden, Widerständen bestimmt. Es gilt allgemein das Faraday'sche Induktionsgesetz für stationäre Ströme
\begin{align}
...
Für die Aufgabe gleicher Widerstände erhalten wir numerisch die gleiche Lösung, die sich bei analytischer Betrachtung ergibt. Für allgemeine Widerstände und weitere Fälle wurden die Schaltungen in \texttt{LTSpice} simuliert und dort konnten unsere berechneten Lösungen verifiziert werden. Zusammengefasst erhalten wir:
\begin{table}[htbp!]
\centering
\begin{tabular}{l|l}
