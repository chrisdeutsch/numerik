...
\end{tabular}
\captionof{table}{Anzahl der hinzugefügten Schalen $n$ gegen Madelung-Konstante $\tilde{\alpha}(n)$ nach $n$-Iterationen des Algorithmus und relativer Fehler $\delta$}
