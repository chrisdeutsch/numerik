...
Die Abbruchbedingung, dass der absolute Fehler $\Delta_\alpha$ kleiner ist als $\epsilon > 0$,
garantiert, wegen $\alpha > 1$, dass für den relativen Fehler $\delta_\alpha < \epsilon$ gilt. Dabei wurde als Literaturwert $\alpha = 1.6155426267128247$\footnote{\href{https://oeis.org/A088537}{A088537} \emph{Decimal expansion of Madelung's constant M2}, \textbf{The On-Line Encyclopedia of Integer Sequences}}
verwendet. Man sieht in Tabelle \ref{tab:konvergenz2d}, dass der Algorithmus auch schnell konvergiert,
dennoch nicht so schnell wie der 3-Dimensionale. Dies relativiert sich dadurch, dass im Zweidimensionalen
