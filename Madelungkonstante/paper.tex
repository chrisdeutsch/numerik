...
dass der relative Fehler $\delta_\alpha < \epsilon$ ist. Dabei wurde als Literaturwert $\alpha = 1.6155426267128247$\footnote{\href{https://oeis.org/A088537}{A088537} \emph{Decimal expansion of Madelung's constant M2}, \textbf{The On-Line Encyclopedia of Integer Sequences}} verwendet. Man sieht in Tabelle \ref{tab:konvergenz2d}, dass der Algorithmus auch schnell konvergiert,dennoch nicht so schnell wie der 3-Dimensionale. Dies relativiert sich dadurch, dass im Zweidimensionalen
