...
Neutralität des Quadrates zu erreichen, die Ecken mit $\frac{1}{4}$ und die Kanten mit
$\frac{1}{2}$ skaliert werden müssen.

\begin{figure}[h]
	\centering
	\includegraphics[scale = 0.4]{./figures/quadrat.eps}
	\caption{Elementarzelle in zwei Dimensionen}
