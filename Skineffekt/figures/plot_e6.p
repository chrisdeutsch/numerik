...
plot "../plots/e6.txt" using 1:2 smooth csplines lt 1 axes x1y1 t'\footnotesize Amplitude', "../plots/e6.txt" using 1:3 with lines lt 2 axes x1y2 t'\footnotesize Phase' 
