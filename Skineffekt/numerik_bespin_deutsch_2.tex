...
\hline 
\rule[2ex]{0pt}{2.5ex} $-\dfrac{1}{(2k-1)^2 (2k)^2}\dfrac{x^4}{16}$ &
$-\dfrac{1}{(2k)^2 (2k+1)^2}\dfrac{x^4}{16}$ &
$-\dfrac{1}{(2k-2) (2k-1)^2 (2k)}\dfrac{x^4}{16}$ &
$-\dfrac{1}{(2k-1) (2k)^2 (2k+1)}\dfrac{x^4}{16}$ \\ 
\end{tabular}
