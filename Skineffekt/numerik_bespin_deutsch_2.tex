...
Die Kelvin-Funktionen wurden mit der Funktion \texttt{test_func} und Vergleichswerten\footnote{Die Vergleichswerte sind im Archiv enthalten} von \emph{Mathematica} auf einem Parameterbereich von $0$ bis $1000$ getestet.
Mit \texttt{kThreshold = 10} und \texttt{kEpsilon = 1E6} weisen die Kelvin-Funktionen einen relativen Fehler von weniger als $10^{-6}$ auf.
