...
\begin{align}
	...
	g_0(x) = \sum^{\infty}_{k=1} \frac{\sin(k \pi / k)}{k! \, (8k)^k} \prod^{k}_{l=1}(2l - 1)^2\label{eq:f0g0}
\end{align}
...
\begin{align}
	...
	g'_0(x) = -\sum^{\infty}_{k=1} \frac{\sin(k \pi / k)}{(k-1)! \, 8^k} \frac{1}{x^{k+1}} \prod^{k}_{l=1}(2l - 1)^2\label{eq:d_f0g0}
\end{align}
...
Im Folgenden geben wir $c(x, k)$ für unsere Reihen an:

\begin{wraptable}{R}[1pt]{0.37\textwidth}
\begin{tabular}{c|c}
Funktion & $c$ \\\hline
\rule[-3.5ex]{0pt}{8ex} ber$_0$ & $-\dfrac{1}{(2k-1)^2 (2k)^2}\dfrac{x^4}{16}$ \\ \hline
\rule[-3.5ex]{0pt}{8ex} bei$_0$ & $-\dfrac{1}{(2k)^2 (2k+1)^2}\dfrac{x^4}{16}$ \\ \hline
\rule[-3.5ex]{0pt}{8ex} ber'$_0$ & $-\dfrac{1}{(2k-2) (2k-1)^2 (2k)}\dfrac{x^4}{16}$ \\ \hline
\rule[-3.5ex]{0pt}{8ex} bei'$_0$ & $-\dfrac{1}{(2k-1) (2k)^2 (2k+1)}\dfrac{x^4}{16}$
\end{tabular}
\caption{CAPTION}
