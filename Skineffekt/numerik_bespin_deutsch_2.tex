...
Formel:
\begin{align}
	j_0(\rho) = \frac{I_0 \kappa}{2 \pi \rho_0} \left( \mathrm{ber}'_0(\kappa \rho_0) + \mathrm{bei}'_0(\kappa \rho_0) \right)^{-1}\\
	\operatorname{Re}(j) = \mathrm{ber}_0(\kappa \rho)\mathrm{bei}'_0(\kappa \rho_0) + \mathrm{bei}_0(\kappa \rho)\mathrm{ber}'_0(\kappa \rho_0)\\
	\operatorname{Im}(j) = - \mathrm{ber}_0(\kappa \rho)\mathrm{ber}'_0(\kappa \rho_0) + \mathrm{bei}_0(\kappa \rho)\mathrm{bei}'_0(\kappa \rho_0)
\end{align}
Die Phase berechnet sich zu:
\begin{align}
	\phi = \operatorname{atan2}(\operatorname{Im}, \operatorname{Re})
\end{align}
Der Betrag:
\begin{align}
	|j| = \left|\frac{I_0 \kappa}{2 \pi \rho_0}\right|\sqrt{\frac{\mathrm{ber}^2_0(\kappa \rho)+\mathrm{bei}^2_0(\kappa \rho)}{\mathrm{ber}'^2_0(\kappa \rho_0)+\mathrm{bei}'^2_0(\kappa \rho_0)}}
\end{align}
